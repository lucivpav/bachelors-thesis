...
Experiments were divided into 5 scenarios. Each scenario differs in type of observed variable(s). The purpose of experiments is to show that my implementation yields reasonable results.
