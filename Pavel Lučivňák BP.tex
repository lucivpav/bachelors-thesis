...
\begin{figure}
	\centering
 	...
 	\caption{Visualization of a mixture with three components with parameters $\mu_1=5, \mu_2=10, \mu_3=15$ and $\sigma_{1,2,3}^2=2^2$. Weights are $w_{1,2,3} = \frac{1}{3}$. Author: Smason79, Wikimedia}
...
The values of the $X$ can be either discrete or continuous. The values of $S$ are assumed to be discrete. There are numerous different definitions of HMM, such as [TODO], [TODO] or [TODO]. The observation probability function $b_i(o)$ describes a probability $P(x_t = o | y_t = S_i)$. $b_i(o)$ is also called an emission function.
...
Given $K$ components, there are $K$ component parameters $\theta_1, \theta_2, \dots, \theta_K$ and $K$ weights $w_1, w_2, \dots, w_K$ to estimate. Here I provide description of Expectation-Maximization algorithm based on TODO. This algorithm provides an estimate of the aforementioned parameters.
